...
- {id: FLEXIO0CLKDIV_HALT, value: Enable}
- {id: LPI2C0CLKDIV_HALT, value: Enable}
- {id: LPI2C2CLKDIV_HALT, value: Enable}
- {id: LPUART0CLKDIV_HALT, value: Enable}
- {id: MRCC.FLEXIO0CLKSEL.sel, value: SCG.FRO_HF}
- {id: MRCC.FREQMEREFCLKSEL.sel, value: MRCC.aoi0_out0}
- {id: MRCC.FREQMETARGETCLKSEL.sel, value: MRCC.aoi0_out0}
- {id: MRCC.FROHFDIV.scale, value: '1', locked: true}
- {id: MRCC.LPI2C0CLKSEL.sel, value: SCG.FRO_12M}
- {id: MRCC.LPI2C2CLKSEL.sel, value: SCG.FRO_12M}
...
void BOARD_BootClockFRO96M(void)
{
    ...
    CLOCK_AttachClk(kFRO12M_to_LPI2C2);                    /* !< Switch LPI2C2 to FRO12M */
    CLOCK_AttachClk(kFRO12M_to_LPUART0);                   /* !< Switch LPUART0 to FRO12M */
    CLOCK_AttachClk(kFRO_HF_to_FLEXIO0);                   /* !< Switch FLEXIO0 to FRO_HF */
    ...
    CLOCK_SetClockDiv(kCLOCK_DivLPI2C2, 1U);               /* !< Set LPI2C2CLKDIV divider to value 1 */
    CLOCK_SetClockDiv(kCLOCK_DivFLEXIO0, 1U);              /* !< Set FLEXIO0CLKDIV divider to value 1 */
